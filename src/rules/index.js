...
import * as input_group from "./components/input-group.js";
...
// Components
const components = [badge, btn_close, btn_link, button, button_base, card, input_group, hljs, input, masonry, modal];
